    ...
    function ctorTypeDrawImage() {
        ...
        return effect.onCreate(function (particle, particleIdx) {
            ...
            if (image instanceof Image) {
                ...
                ctx.drawImage(image.image, image.offsetX, image.offsetY, image.width, image.height, -image.width / 2, -image.height / 2, image.width, image.height);
...
Fireworks.BindTriggerDomEvents = function (emitter, domElement) {
    ...
    this._onMouseUp = function () {
        emitter.effect('spawner').opts.stop();
    };
